...
public class SuspenderProcessosUseCaseTest {
    ...
    void deveArquivarTodosOsIds() {
        ...
        suspenderProcessosUseCase.execute(new LoteIdsRequest(List.of(id1, id2)));

        assertThat(processo1.getStatus()).isEqualTo(StatusProcesso.SUSPENSO);
        assertThat(processo2.getStatus()).isEqualTo(StatusProcesso.SUSPENSO);
    }
    ...
    void deveLancarErroQuandoAlgumIdNaoExiste() {
        ...
        assertThatThrownBy(() -> suspenderProcessosUseCase.execute(new LoteIdsRequest(List.of(id1, id2))))
