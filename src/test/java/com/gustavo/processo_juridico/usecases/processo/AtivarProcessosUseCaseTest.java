...
public class AtivarProcessosUseCaseTest {
    ...
    void deveArquivarTodosOsIds() {
        ...
        ativarProcessosUseCase.execute(new LoteIdsRequest(List.of(id1, id2)));

        assertThat(processo1.getStatus()).isEqualTo(StatusProcesso.ATIVO);
        assertThat(processo2.getStatus()).isEqualTo(StatusProcesso.ATIVO);
    }
    ...
    void deveLancarErroQuandoAlgumIdNaoExiste() {
        ...
        assertThatThrownBy(() -> ativarProcessosUseCase.execute(new LoteIdsRequest(List.of(id1, id2))))
